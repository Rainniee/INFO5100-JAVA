...
public class LyricAnalyzer {
	...
	String path = "C:\\Users\\apple\\Documents\\NetBeansProjects\\Assignment8\\src\\assignment8\\Question2_test1.txt";//The Output.txt is done used Question2_test1.txt
	File testFile = new File(path);
	la.read(testFile);
	la.displayWords();
	System.out.println("Unique words count: " + la.count());
	System.out.println("Most frequently word: " + la.mostFrequentWord());
	path = "C:\\Users\\apple\\Documents\\NetBeansProjects\\Assignment8\\src\\assignment8\\Question2_output.txt";
